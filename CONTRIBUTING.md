...
Hashgraph is grateful for any contributions it receives from the community. Contributions can come in many shapes
...
are reporting a _security vulnerability_, please send the report to [security@hashgraph.com](mailto:security@hashgraph.com).
...
Hashgraph uses [Semantic Versioning](https://semver.org) for releases to convey meaning about the underlying code and what
